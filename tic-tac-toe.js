...
function kDiv(s){
	...
	console.log(s);
	if (document.getElementById("sira_belirtec").innerHTML == "Sıra: X"){
		document.getElementById("sira_belirtec").innerHTML = "Sıra: O"
	} else {
		document.getElementById("sira_belirtec").innerHTML = "Sıra: X"
	}
	if (anahtar == 1){
		if (tahta[s-1] == ""){
			tahta[s-1] = "x";
